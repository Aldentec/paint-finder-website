...
const HowItWorksPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Our database includes hundreds of paints from major manufacturers, regularly updated with new releases and accurate color values.",
      icon: "🎨",
      details: [
        "Citadel, Vallejo, & Army Painter",
          ...
          <div className="container">
            <div className="features-header">
              ...
              <p className="section-subtitle">
                Built with cutting-edge algorithms.
              </p>
            </div>
