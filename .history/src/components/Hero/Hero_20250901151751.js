      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "PaintFinder - AI Paint Color Matching",
            ...
            "url": "https://paintfinder.com",
            "mainEntity": {
              "@type": "SoftwareApplication",
              "name": "PaintFinder Paint Matcher",
      ...
      >
        ...
        <div className="hero-content">
          ...
          >
            ...
            from <strong>Citadel, Vallejo, Army Painter</strong> and more. Powered by advanced color science 
          ...
          <div className="hero-stats" role="complementary" aria-label="Usage statistics">
            <div className="stat-item">
              <strong className="stat-number" aria-label="Over 5000 paints in database">5000+</strong>
