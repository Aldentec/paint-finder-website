...
const PaintMatcher = () => {
  ...
  useEffect(() => {
    // Add structured data for the paint matcher tool
    const structuredData = {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "Hobby Paint Finder Color Matcher",
      "description": "Upload miniature photos to find matching hobby paints using AI color analysis and ΔE2000 color science",
      "url": "https://hobbypaintfinder.com/#paint-matcher",
      "applicationCategory": "UtilitiesApplication",
      "operatingSystem": "Web Browser",
      "featureList": [
        "AI-powered color extraction from images",
        "ΔE2000 color matching algorithm", 
        "Multi-brand paint database (Citadel, Vallejo, Army Painter)",
        "Automatic shopping list generation",
        "K-means clustering color analysis",
        "Smart image presets for different miniature types"
      ],
      "offers": {
        "@type": "Offer",
        "price": "0",
    ...
    return () => {
      ...
      scripts.forEach(s => {
        if (s.textContent.includes('Hobby Paint Finder Color Matcher')) {
          s.remove();
        }
      });
    };
            ...
            <div className="upload-controls">
              ...
              <div role="group" aria-labelledby="image-upload-label">
                ...
                <p id="upload-instructions" className="sr-only">
                  Upload a photo of your miniature to extract colors and find matching hobby paints from Citadel, Vallejo, Army Painter and other brands
                </p>
              </div>
