  ...
  const extract = useCallback(
    async (
      ...
      const {
        ignoreWhites = true,
        ignoreBlacks = true,
        whiteThresh = 250, // was 245
        blackThresh = 5,   // was 10
        maxWidth = 512,
        sampleStep = 2,    // was 4 → better chance to catch small patches
        minChroma = 0,     // e.g. 5–8 to drop near-grays if needed
        ensureBlue = true,
        blueHueRange = [200, 260], // degrees
        minBlueFraction = 0.003    // 0.3% of samples must be blue to force
      } = options;
